...
<script type="text/javascript" src='resources/js/outlook2.js'>
	
</script>
<script type="text/javascript">
	// 登录菜单，页面加载完成异步加载 --> outlook2.js
...
<body class="easyui-layout" style="overflow-y: hidden" scroll="no">
	...
	<div region="north" split="true" border="false"
		...
		<span style="float: right; padding-right: 20px;" class="head">欢迎
			登录 <a href="#" id="editpass">修改密码</a> <a href="#" id="loginOut">安全退出</a>
	...
	<div region="south" split="true"
		...
		<div class="footer">睿思源教学后台管理</div>
	</div>
	...
	<div id="mainPanle" region="center"
		...
		<div id="tabs" class="easyui-tabs" fit="true" border="false">
			<div title="欢迎使用"
				...
				<h1 style="font-size: 24px;">* 作者：睿思源-姚老师</h1>
